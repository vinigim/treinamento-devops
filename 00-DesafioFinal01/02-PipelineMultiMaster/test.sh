...
# cd /var/lib/jenkins/workspace/PipelineDeployK8s/00-DesafioFinal01/02-PipelineMultiMaster/0-terraform
# terraform init
...
EOF
 ...
 ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i hosts /var/lib/jenkins/workspace/PipelineDeployK8s/00-DesafioFinal01/02-PipelineMultiMaster/2-ansible/01-k8s-install-masters_e_workers/2-provisionar-k8s-master-test.yml -u ubuntu --private-key /var/lib/jenkins/.ssh/id_rsa
