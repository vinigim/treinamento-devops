...
ID_M1=$(terraform output | grep 'vini-k8s-master-desafio -' | awk '{print $4;exit}')
ID_M1_DNS=$(terraform output | grep 'vini-k8s-master-desafio -' | awk '{print $9;exit}' | cut -b 8-)

ID_W1=$(terraform output | grep 'vini-k8s-node-1-desafio -' | awk '{print $4;exit}')
ID_W1_DNS=$(terraform output | grep 'vini-k8s-node-1-desafio -' | awk '{print $9;exit}' | cut -b 8-)

ID_W2=$(terraform output | grep 'vini-k8s-node-2-desafio -' | awk '{print $4;exit}')
ID_W2_DNS=$(terraform output | grep 'vini-k8s-node-2-desafio -' | awk '{print $9;exit}' | cut -b 8-)

ID_W3=$(terraform output | grep 'vini-k8s-node-3-desafio -' | awk '{print $4;exit}')
ID_W3_DNS=$(terraform output | grep 'vini-k8s-node-3-desafio -' | awk '{print $9;exit}' | cut -b 8-)
...
# ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i hosts 2-provisionar-k8s-master-auto-shell.yml -u ubuntu --private-key /home/ubuntu/.ssh/id_rsa